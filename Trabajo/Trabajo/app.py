...
app.config['S3_BUCKET'] = 'andrew-s3-123'  # Reemplaza con el nombre de tu bucket de S3
...
s3 = boto3.client('s3',
                   aws_access_key_id='AKIAQJOOBZPSYUSTYG4N,wUcbtZ',
                   aws_secret_access_key='OTpqIjC9hpw7Eij6fJmjMa10orQxgb6Oj',
